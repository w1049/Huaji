...
public class EntityHuajiBoss extends EntityWither implements IBossDisplayData, IRangedAttackMob {
	...
	public EntityHuajiBoss(World p_i1701_1_) {
		super(p_i1701_1_);
	...
	private void func_82209_a(int p_82209_1_, double p_82209_2_, double p_82209_4_, double p_82209_6_,
		...
		EntityBossSkull e = new EntityBossSkull(this.worldObj, this, d6, d7, d8);
	...
	protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
		this.dropItem(ItemLoader.bossStar, 1);
