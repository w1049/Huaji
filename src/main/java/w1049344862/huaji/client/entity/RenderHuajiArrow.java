...
public class RenderHuajiArrow extends Render {
	private static final ResourceLocation arrowTextures = new ResourceLocation("huaji:textures/entity/huaji_arrow.png");
